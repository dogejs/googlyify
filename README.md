...
~~~sh
# getting the code
git clone git@github.com:nko4/googlyify.git && cd ./googlyify/

# developing
npm install
npm start

# deploying (to http://googlyify.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@googlyify.2013.nodeknockout.com
ssh root@googlyify.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@googlyify.2013.nodeknockout.com
ssh -i ./id_deploy root@googlyify.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/googlyify" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
